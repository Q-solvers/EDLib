...
int main(int argc, const char ** argv) {
  ...
  try {
    ...
    EDLib::gf::GreensFunction < EDLib::SRSHubbardHamiltonian, EDLib::MatsubaraMeshFactory, alps::gf::statistics::statistics_type> greensFunction(params, ham,alps::gf::statistics::statistics_type::FERMIONIC);
    // Compute and store local Green's function
    greensFunction.compute();
    greensFunction.save(ar, "results");
    // Construct two particle Green's function object
    EDLib::gf::ChiLoc<EDLib::SRSHubbardHamiltonian, EDLib::MatsubaraMeshFactory, alps::gf::statistics::statistics_type> susc(params, ham, alps::gf::statistics::statistics_type::BOSONIC);
