...
int main(int argc, const char ** argv) {
  ...
  try {
    ...
    EDLib::gf::GreensFunction < HamType, EDLib::MatsubaraMeshFactory, alps::gf::statistics::statistics_type> greensFunction(params, ham, alps::gf::statistics::FERMIONIC);
    ...
    if(params["COMPUTE_REAL"].as<bool>()) {
      ...
      EDLib::gf::GreensFunction < HamType, EDLib::RealFreqMeshFactory> greens(params, ham);
    ...
    EDLib::gf::ChiLoc<HamType, EDLib::MatsubaraMeshFactory, alps::gf::statistics::statistics_type > susc(params, ham, alps::gf::statistics::BOSONIC);
